...
class PageDemographic:
    ...
    def __getFansAddnRemove(self):
        ...
        self.__newLikes ={ "new_likes": [add_timestamp,add] }
        self.__newRemovedLikes ={ "new_removed_likes": [remove,remove_timestamp] }
        # DEBUG:
    ...
    def __getPageFansGender(self):
        ...
        self.__ageGender = {"gender_age": [keys,values,percentage]}
        #DEBUG:
    ...
    def __getPageImpression(self):
        ...
        self.__pageImpression ={ "page_impression": [timestamp,value] }
         # DEBUG:
    ...
    def __getTotalPageViews(self):
        ...
        self.__pageViews ={ "page_views": [timestamp,value] }
         # DEBUG:
    ...
    def getDemographics(self):
        ...
        return { "demographics":[
            self.__city,
            self.__newLikes,
            self.__newRemovedLikes,
            self.__ageGender,
            self.__pageImpression,
            self.__pageViews
        ]
         }
